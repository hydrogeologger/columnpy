...
%% ---------read file---------------
% the ',' is delimiter
em50=importdata('em50.csv',',');
%scale=importdata('scale.csv');
...
%dt8s=dt85g.textdata(2:size(dt85g.textdata,1),1);
...
% em
%em50.vwc_pt1  = em50.data(:,1);
%em50.vwc_pt2  = em50.data(:,2);
%em50.vwc_pt3  = em50.data(:,3);
em50.rh_pt1    = em50.data(:,1);
em50.temp_pt1  = em50.data(:,2);
em50.rh_pt2    = em50.data(:,3);
em50.temp_pt2  = em50.data(:,4);
em50.rh_pt3    = em50.data(:,5);
em50.temp_pt3  = em50.data(:,6);
em50.rh_pt4    = em50.data(:,7);
em50.temp_pt4  = em50.data(:,8);
em50.rh_pt5    = em50.data(:,9);
em50.temp_pt5  = em50.data(:,10);


% post processing data
%tmp=em50.vwc_pt1<0.01; em50.vwc_pt1(tmp)=nan;
%
%tmp=em50.vwc_pt2<0.01; em50.vwc_pt2(tmp)=nan;
%
%tmp=em50.vwc_pt3<0.01; em50.vwc_pt3(tmp)=nan;

% warning: plus is more superior than <>
% strange that below is not working!
%tmp=(em50.rh_pt4<0) + (em50.rh_pt4>1.2); em50.rh_pt4(tmp)=nan;


%tmp=[find(em50.rh_pt4<0),find(em50.rh_pt4>1.2)]; em50.rh_pt4(tmp)=nan;
%tmp=[find(em50.rh_pt5<0),find(em50.rh_pt5>1.2)]; em50.rh_pt5(tmp)=nan;


%tmp=em50.temp_pt4<5; em50.temp_pt4(tmp)=NaN;
%tmp=em50.temp_pt5<5; em50.temp_pt5(tmp)=nan;
%
%
%
%
