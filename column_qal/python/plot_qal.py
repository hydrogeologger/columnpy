...
ax[1].plot(ta['date_time'], ta['vis_up'], 'r-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A')
ax[1].set_ylim([0,4000])


ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp0'][::mkevy].values, 'r-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp1'][::mkevy].values, 'g-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='Dielectric suction B',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp2'][::mkevy].values, 'b-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='Moisture A',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp3'][::mkevy].values, 'c-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='Moisture A',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp4'][::mkevy].values, 'm-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='Moisture A',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp5'][::mkevy].values, 'k-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='Moisture A',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp6'][::mkevy].values, '-' ,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Moisture A',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp7'][::mkevy].values, '-' ,markerfacecolor='yellow' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='yellow',label='Moisture A',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp8'][::mkevy].values, '-' ,markerfacecolor='orange' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='orange',label='Moisture A',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tmp9'][::mkevy].values, '-' ,markerfacecolor='pink' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='pink',label='Moisture A',markevery=mkevy)

mkevy=12

ax[3].plot(ta['date_time'][::mkevy], ta['mo0'][::mkevy], 'r-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['mo1'][::mkevy], 'g-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='Dielectric suction B',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['mo2'][::mkevy], 'b-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='Moisture A',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['mo3'][::mkevy], 'c-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='Moisture A',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['mo4'][::mkevy], 'm-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='Moisture A',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['mo5'][::mkevy], 'k-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='Moisture A',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['mo6'][::mkevy], '-' ,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Moisture A',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['mo7'][::mkevy], '-' ,markerfacecolor='yellow' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='yellow',label='Moisture A',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['mo8'][::mkevy], '-' ,markerfacecolor='orange' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='orange',label='Moisture A',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['mo9'][::mkevy], '-' ,markerfacecolor='pink' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='pink',label='Moisture A',markevery=mkevy)

ax[4].plot(ta['date_time'], ta['ec0'], 'r-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A')
...
ax[5].plot(ta['date_time'], ta['pre0'], 'r-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A')
