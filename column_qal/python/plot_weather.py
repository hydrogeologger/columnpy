...
ax[2].plot(ta['date_time'][::mkevy].values, ta['tc'][::mkevy].values, 'r-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A',markevery=mkevy)
ax[2].plot(ta['date_time'][::mkevy].values, ta['tp_box_7'][::mkevy].values, 'g-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='Dielectric suction B',markevery=mkevy)
ax[2].set_ylim([20,50])

mkevy=12

ax[3].plot(ta['date_time'][::mkevy], ta['rh'][::mkevy], 'r-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A',markevery=mkevy)
ax[3].plot(ta['date_time'][::mkevy], ta['dhthum0'][::mkevy], 'g-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='Dielectric suction B',markevery=mkevy)
ax[3].set_ylim([0,100])

ax[4].plot(ta['date_time'], ta['wdspdkphavg2m'], 'r-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A')
...
ax[5].plot(ta['date_time'], ta['p'], 'r-',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A')
ax[5].set_ylim([98000,102000])
