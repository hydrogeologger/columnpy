...
for line in open("schedule.ipt"):
    ...
    if not li.startswith("#"):
        ...
        sp_sch[sch_name].merge_data(df=data_weather_daisy.df, keys=['vis_up']   ,plot=plot_interpolate  ,coef=5e-4)
        ...
        sp_sch[sch_name].df['pre0']=sp_sch[sch_name].df['pre0'].values-1005.35
        sp_sch[sch_name].df['pre1']=sp_sch[sch_name].df['pre1'].values-1005.35




        #sp_sch[sch_name].merge_data(df=data_weather_camellia.df, keys=['rainmm']   ,plot=plot_interpolate  ,coef=5e-06)  # done
        ...
        #sp_sch[sch_name].merge_data(df=data.df, keys=['balance_bottom']   ,plot=plot_interpolate  ,coef=5e-17)  # done
        ...
        #sp_sch[sch_name].df['cum_evap']=(sp_sch[sch_name].df['balance_bottom'][0]-sp_sch[sch_name].df['balance_bottom']
