...
for i in plt_profile_2['time2']:
   ...
   plt_profile_2['time_idx_c4_lo'][i], min_value = min(enumerate( abs(prof['grange_5_luo2_dry']['data'].df.index- plt_profile_2['time64'][i] )), key=operator.itemgetter(1))
   ...
   plt_profile_2['time_idx_c5_lo'][i], min_value = min(enumerate( abs(prof['grange_3_luo2_dry']['data'].df.index- plt_profile_2['time64'][i] )), key=operator.itemgetter(1))
   ...
   plt_profile_2['time_idx_c6_lo'][i], min_value = min(enumerate( abs(prof['grange_4_luo2_dry']['data'].df.index- plt_profile_2['time64'][i] )), key=operator.itemgetter(1))
   ...
   plt_profile_2['oxygen_dry_c4_mo'][i]=prof['grange_5_mo_su']['data'].df.iloc[ plt_profile_2['time_idx_c4_mo'][i] ][['dluo7']].tolist()
   plt_profile_2['oxygen_dry_c4_lo'][i]=prof['grange_5_luo2_dry']['data'].df.iloc[ plt_profile_2['time_idx_c4_lo'][i] ][['dluo6','dluo5','dluo4','dluo3','dluo2','dluo1','dluo0']].tolist()
   plt_profile_2['oxygen_dry_c5_mo'][i]=prof['grange_3_mo_su']['data'].df.iloc[ plt_profile_2['time_idx_c5_mo'][i] ][['dluo7']].tolist()
   plt_profile_2['oxygen_dry_c5_lo'][i]=prof['grange_3_luo2_dry']['data'].df.iloc[ plt_profile_2['time_idx_c5_lo'][i] ][['dluo6','dluo5','dluo4','dluo3','dluo1','dluo0']].tolist()
   ...
   plt_profile_2['oxygen_dry_c6_mo'][i]=prof['grange_4_mo_su']['data'].df.iloc[ plt_profile_2['time_idx_c6_mo'][i] ][['dluo7']].tolist()
   plt_profile_2['oxygen_dry_c6_lo'][i]=prof['grange_4_luo2_dry']['data'].df.iloc[ plt_profile_2['time_idx_c6_lo'][i] ][['dluo6','dluo5','dluo4','dluo3','dluo2','dluo1','dluo0']].tolist()
   plt_profile_2['oxygen_dry_c4'][i]= plt_profile_2['oxygen_dry_c4_mo'][i] + plt_profile_2['oxygen_dry_c4_lo'][i]
   plt_profile_2['oxygen_dry_c5'][i]= plt_profile_2['oxygen_dry_c5_mo'][i] + plt_profile_2['oxygen_dry_c5_lo'][i]
   plt_profile_2['oxygen_dry_c6'][i]= plt_profile_2['oxygen_dry_c6_mo'][i] + plt_profile_2['oxygen_dry_c6_lo'][i]
...
depth_y_a=np.array([0.5,1.0,1.5,2.0,2.5,3.5,4.0])
...
for i in plt_profile_2['time2']:
    ...
    ax[0].plot(plt_profile_2['oxygen_dry_c4'][i],depth_y_b,'-',color=plt_profile_2['color'][i],label=plt_profile_2['legend'][i] )
    ax[1].plot(plt_profile_2['oxygen_dry_c5'][i],depth_y_a,'-',color=plt_profile_2['color'][i],label=plt_profile_2['legend'][i] )
    ax[2].plot(plt_profile_2['oxygen_dry_c6'][i],depth_y_b,'-',color=plt_profile_2['color'][i],label=plt_profile_2['legend'][i] )
...
fig.savefig('figure/plot_oxdry_profile_c456.png', format='png', dpi=100)
#plt.close()
