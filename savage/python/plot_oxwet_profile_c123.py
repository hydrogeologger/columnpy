...
for i in plt_profile_2['time']:
   ...
   plt_profile_2['time_idx_c2_e'][i], min_value = min(enumerate( abs(prof['grange_b_moisture_suction']['data'].df.index- plt_profile_2['time64'][i] )), key=operator.itemgetter(1))
   ...
   plt_profile_2['oxygen_wet_c1_e'][i]=prof['grange_a_electrochem_o2']['data'].df.iloc[ plt_profile_2['time_idx_c1_e'][i] ][['wox3_c','wox2_c','wox1_c']].tolist()
   #plt_profile_2['oxygen_dry_c1_lo'][i]=prof['grange_a_luo2']['data'].df.iloc[ plt_profile_2['time_idx_c1_lo'][i] ][['wluo6','wluo5']].tolist()
   plt_profile_2['oxygen_wet_c2_e'][i]=prof['grange_b_electrochem_o2']['data'].df.iloc[ plt_profile_2['time_idx_c2_e'][i] ][['wox7_c','wox1_c']].tolist()
   plt_profile_2['oxygen_wet_c2_lo'][i]=prof['grange_b_luo2']['data'].df.iloc[ plt_profile_2['time_idx_c2_lo'][i] ][['wluo5']].tolist()
   plt_profile_2['oxygen_wet_c3_e'][i]=prof['grange_d_electrochem_o2']['data'].df.iloc[ plt_profile_2['time_idx_c3_e'][i] ][['wox3_c','wox0_c']].tolist()
   plt_profile_2['oxygen_wet_c3_lo'][i]=prof['grange_d_luo2']['data'].df.iloc[ plt_profile_2['time_idx_c3_lo'][i] ][['wluo5']].tolist()
   plt_profile_2['oxygen_wet_c1'][i]= plt_profile_2['oxygen_wet_c1_e'][i]
   plt_profile_2['oxygen_wet_c2'][i]= [plt_profile_2['oxygen_wet_c2_e'][i][0]]+plt_profile_2['oxygen_wet_c2_lo'][i]+plt_profile_2['oxygen_wet_c2_e'][i][1:]
   plt_profile_2['oxygen_wet_c3'][i]= plt_profile_2['oxygen_wet_c3_lo'][i]+plt_profile_2['oxygen_wet_c3_e'][i]
   plt_profile_2['oxygen_wet_c1'][i]= np.array(plt_profile_2['oxygen_wet_c1_e'][i]).astype(np.double)
   plt_profile_2['oxygen_wet_c2'][i]= np.array([plt_profile_2['oxygen_wet_c2_e'][i][0]]+plt_profile_2['oxygen_wet_c2_lo'][i]+plt_profile_2['oxygen_wet_c2_e'][i][1:]).astype(np.double)
   plt_profile_2['oxygen_wet_c3'][i]= np.array(plt_profile_2['oxygen_wet_c3_lo'][i]+plt_profile_2['oxygen_wet_c3_e'][i]).astype(np.double)
   mask_a = np.isfinite(plt_profile_2['oxygen_wet_c1'][i])
   mask_b = np.isfinite(plt_profile_2['oxygen_wet_c2'][i])
   mask_d = np.isfinite(plt_profile_2['oxygen_wet_c3'][i])
...
ax[1].set_xlabel('OXYGEN CONC. (%)')
ax[2].set_xlabel('OXYGEN CONC. (%)')
...
for i in plt_profile_2['time']:
    ...
    ax[0].plot(plt_profile_2['oxygen_wet_c1'][i][mask_a],depth_y_a[mask_a],'-',color=plt_profile_2['color'][i],label=plt_profile_2['legend'][i] )
    ax[1].plot(plt_profile_2['oxygen_wet_c2'][i][mask_b],depth_y_b[mask_b],'-',color=plt_profile_2['color'][i],label=plt_profile_2['legend'][i] )
    ax[2].plot(plt_profile_2['oxygen_wet_c3'][i][mask_d],depth_y_d[mask_d],'-',color=plt_profile_2['color'][i],label=plt_profile_2['legend'][i] )
