...
for i in plt_profile_2['time2']:
   ...
   plt_profile_2['time_idx_c4'][i], min_value = min(enumerate( abs(prof['grange_5_mo_su']['data'].df.index- plt_profile_2['time64'][i] )), key=operator.itemgetter(1))
   plt_profile_2['time_idx_c5'][i], min_value = min(enumerate( abs(prof['grange_3_mo_su']['data'].df.index- plt_profile_2['time64'][i] )), key=operator.itemgetter(1))
   plt_profile_2['time_idx_c6'][i], min_value = min(enumerate( abs(prof['grange_4_mo_su']['data'].df.index- plt_profile_2['time64'][i] )), key=operator.itemgetter(1))
   ...
   plt_profile_2['moisture_c4'][i]=prof['grange_5_mo_su']['data'].df.iloc[ plt_profile_2['time_idx_c4'][i] ][['mo7_c','mo6_c','mo5_c','mo4_c','mo3_c','mo2_c','mo1_c','mo0_c']].tolist()
   plt_profile_2['moisture_c5'][i]=prof['grange_3_mo_su']['data'].df.iloc[ plt_profile_2['time_idx_c5'][i] ][['mo7_c','mo6_c','mo5_c','mo4_c','mo3_c','mo2_c','mo1_c','mo0_c']].tolist()
   plt_profile_2['moisture_c6'][i]=prof['grange_4_mo_su']['data'].df.iloc[ plt_profile_2['time_idx_c6'][i] ][['mo7_c','mo6_c','mo5_c','mo4_c','mo3_c','mo2_c','mo1_c','mo0_c']].tolist()
...
for i in plt_profile_2['time2']:
    ax[0].plot(plt_profile_2['moisture_c4'][i],depth_y,'-',color=plt_profile_2['color'][i],label=plt_profile_2['legend'][i] )
    ax[1].plot(plt_profile_2['moisture_c5'][i],depth_y,'-',color=plt_profile_2['color'][i],label=plt_profile_2['legend'][i] )
    ax[2].plot(plt_profile_2['moisture_c6'][i],depth_y,'-',color=plt_profile_2['color'][i],label=plt_profile_2['legend'][i] )
...
#ax[0].legend(bbox_to_anchor=(0.99, 0.004 ), loc='lower right', borderaxespad=0.,fontsize=10,handletextpad=0.23,labelspacing=0.22,ncol=1,columnspacing=0.4)
ax[1].legend(bbox_to_anchor=(0.5, 1.07 ), loc='center', borderaxespad=0.,fontsize=10,handletextpad=0.23,labelspacing=0.22,ncol=2,columnspacing=0.4)
...
fig.savefig('figure/plot_mo_profile_c456.png', format='png', dpi=100)
#plt.close()
