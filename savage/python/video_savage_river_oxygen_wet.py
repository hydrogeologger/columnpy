...
for ii in range(len(date)):
    ...
    depth_y_b=np.array([0.5,1.5,3.5])
    ...
    mergedlist_b=np.array([ox_b_e[0]]+ox_b_lo+ox_b_e[1:])
    ...
    mergedlist_d=np.array(ox_d_lo+ox_d_e)
    ...
    mergedlist_3=np.array(ox_3_mo+ox_3_lo) #merge two lists
    mask_3 = np.isfinite(mergedlist_3)

    ox_4_mo=prof['grange_4_mo_su']['data'].df.iloc[idx_im_4_mo][['wluo7']].tolist()
    ox_4_lo=prof['grange_4_luo2_wet']['data'].df.iloc[idx_im_4_lo][['wluo6','wluo5','wluo4','wluo3','wluo2','wluo1','wluo0']].tolist()
    mergedlist_4=np.array(ox_4_mo+ox_4_lo)
    mask_4 = np.isfinite(mergedlist_4)

    ox_5_mo=prof['grange_5_mo_su']['data'].df.iloc[idx_im_5_mo][['wluo7']].tolist()          
    ox_5_lo=prof['grange_5_luo2_wet']['data'].df.iloc[idx_im_5_lo][['wluo6','wluo5','wluo4','wluo3','wluo2','wluo1','wluo0']].tolist()
    mergedlist_5=np.array(ox_5_mo+ox_5_lo)
    mask_5 = np.isfinite(mergedlist_5)

    ax_ox_abd.plot(mergedlist_a[mask_a],depth_y_a[mask_a],'-',color='darkblue',label='Column_1')
    ax_ox_abd.plot(mergedlist_b[mask_b],depth_y_b[mask_b],'-',color='lightblue',label='Column_2')
    ax_ox_abd.plot(mergedlist_d[mask_d],depth_y_d[mask_d],'-',color='cyan',label='Column_3')
    ax_ox_abd.set_ylim([4.5,0.2])
    ax_ox_abd.set_xlim([-1,28])
    ax_ox_abd.xaxis.set_major_locator(plt.MaxNLocator(5))
 
    ax_ox_345.plot(mergedlist_5[mask_5],depth_y[mask_5],'-',color='maroon',label='Column_4') 
    ax_ox_345.plot(mergedlist_3[mask_3],depth_y[mask_3],'-',color='gold',label='Column_5')
    ax_ox_345.plot(mergedlist_4[mask_4],depth_y[mask_4],'-',color='peru',label='Column_6')
    ax_ox_345.set_ylim([4.5,0.2])
    ax_ox_345.set_xlim([-1,28])
    ...
    ax[2][0].plot(   sp[:idx_im_a_e+1].index[::iv],      sp.wox3_c[:idx_im_a_e+1][::iv],'-',color='olive'    ,markevery=mark_every,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='2.0m',ms=12)
    ax[2][0].plot(   sp[:idx_im_a_e+1].index[::iv],      sp.wox2_c[:idx_im_a_e+1][::iv],'-',color='gold'     ,markevery=mark_every,markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='2.5m',ms=12)
    ax[2][0].plot(   sp[:idx_im_a_e+1].index[::iv],      sp.wox1_c[:idx_im_a_e+1][::iv],'-',color='peru'     ,markevery=mark_every,markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='3.0m',ms=12)
    ...
    mark_every=24
    iv=100
    ax[3][0].plot(sp[:idx_im_b_e+1].index[::iv], sp.wox7_c[:idx_im_b_e+1][::iv],'-',color='darkblue',markersize=ms+3,markeredgewidth=mew, markeredgecolor='m',label='0.5m',ms=12,markevery=mark_every,fillstyle='full')
    #ax[3][0].plot(sp_lo[:idx_im_b_lo+1].index[::iv], sp_lo.wluo6[:idx_im_b_lo+1][::iv],'-',color='royalblue',markersize=ms+3,markeredgewidth=mew, markeredgecolor='m',label='1.0m',ms=12,markevery=mark_every,fillstyle='full')
    ax[3][0].plot(sp_lo[:idx_im_b_lo+1].index[::iv], sp_lo.wluo5[:idx_im_b_lo+1][::iv],'-',color='lightblue',markersize=ms,markeredgewidth=mew, markeredgecolor='b',label='1.5m',ms=12,markevery=mark_every,fillstyle='full')
    ...
    #ax[3][0].plot(sp[:idx_im_b_e+1].index[::iv], sp.wox3_c[:idx_im_b_e+1][::iv],'-',color='olive',markersize=ms,markeredgewidth=mew, markeredgecolor='r',label='2.5m',ms=12,markevery=mark_every,fillstyle='full')
    ...
    ax[3][0].plot(sp[:idx_im_b_e+1].index[::iv], sp.wox1_c[:idx_im_b_e+1][::iv],'-',color='peru',markersize=ms-3,markeredgewidth=mew, markeredgecolor='k',label='3.5m',ms=12,markevery=mark_every,fillstyle='full')
    ...
    ax[4][0].plot(sp_lo[:idx_im_d_lo+1].index[::iv], sp_lo.wluo5[:idx_im_d_lo+1][::iv],'-',color='lightblue',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='1.5m',ms=12)
    ...
    ax[4][0].plot(sp[:idx_im_d_e+1].index[::iv], sp.wox3_c[:idx_im_d_e+1][::iv],'-',color='olive',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='2.5m',ms=12)
    ...
    ax[4][0].plot(sp[:idx_im_d_e+1].index[::iv], sp.wox0_c[:idx_im_d_e+1][::iv],'-',color='maroon',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='4.0m',ms=12)

    #sp_wlo=prof['grange_5_luo2_wet']['data'].df
    sp_lo=prof['grange_5_luo2_wet']['data'].df
    sp_moi=prof['grange_5_mo_su']['data'].df
    mark_every=24
    iv=100
    ax[5][0].plot(sp_moi[:idx_im_5_mo+1].index[::iv], sp_moi.wluo7[:idx_im_5_mo+1][::iv],'-',color='darkblue',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='0.5m',markevery=mark_every,ms=12)
    ax[5][0].plot(sp_lo[:idx_im_5_lo+1].index[::iv], sp_lo.wluo6[:idx_im_5_lo+1][::iv],'-',color='royalblue',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='1.0m',markevery=mark_every,ms=12)
    ax[5][0].plot(sp_lo[:idx_im_5_lo+1].index[::iv], sp_lo.wluo5[:idx_im_5_lo+1][::iv],'-',color='lightblue',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='1.5m',markevery=mark_every,ms=12)
    ax[5][0].plot(sp_lo[:idx_im_5_lo+1].index[::iv], sp_lo.wluo4[:idx_im_5_lo+1][::iv],'-',color='limegreen',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='2.0m',markevery=mark_every,ms=12)
    ax[5][0].plot(sp_lo[:idx_im_5_lo+1].index[::iv], sp_lo.wluo3[:idx_im_5_lo+1][::iv],'-',color='olive',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='2.5m',markevery=mark_every,ms=12)
    ax[5][0].plot(sp_lo[:idx_im_5_lo+1].index[::iv], sp_lo.wluo2[:idx_im_5_lo+1][::iv],'-',color='gold',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='3.0m',markevery=mark_every,ms=12)
    ax[5][0].plot(sp_lo[:idx_im_5_lo+1].index[::iv], sp_lo.wluo1[:idx_im_5_lo+1][::iv],'-',color='peru',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='3.5m',ms=12,markevery=mark_every)
    ax[5][0].plot(sp_lo[:idx_im_5_lo+1].index[::iv], sp_lo.wluo0[:idx_im_5_lo+1][::iv],'-',color='maroon',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='4.0m',markevery=mark_every)
  
    #sp_wlo=prof['grange_3_luo2_wet']['data'].df
    sp_lo=prof['grange_3_luo2_wet']['data'].df
    sp_moi=prof['grange_3_mo_su']['data'].df
    mark_every=24
    iv=100
    ax[6][0].plot(sp_moi[:idx_im_3_mo+1].index[::iv], sp_moi.wluo7[:idx_im_3_mo+1][::iv],'-',color='darkblue',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='0.5m',markevery=mark_every,ms=12)
    ax[6][0].plot(sp_lo[:idx_im_3_lo+1].index[::iv], sp_lo.wluo6[:idx_im_3_lo+1][::iv],'-',color='royalblue',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='1.0m',markevery=mark_every,ms=12)
    ax[6][0].plot(sp_lo[:idx_im_3_lo+1].index[::iv], sp_lo.wluo5[:idx_im_3_lo+1][::iv],'-',color='lightblue',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='1.5m',markevery=mark_every,ms=12)
    ax[6][0].plot(sp_lo[:idx_im_3_lo+1].index[::iv], sp_lo.wluo4[:idx_im_3_lo+1][::iv],'-',color='limegreen',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='2.0m',markevery=mark_every,ms=12)
    ax[6][0].plot(sp_lo[:idx_im_3_lo+1].index[::iv], sp_lo.wluo3[:idx_im_3_lo+1][::iv],'-',color='olive',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='2.5m',markevery=mark_every,ms=12)
    ax[6][0].plot(sp_lo[:idx_im_3_lo+1].index[::iv], sp_lo.wluo2[:idx_im_3_lo+1][::iv],'-',color='gold',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='3.0m',markevery=mark_every,ms=12)
    ax[6][0].plot(sp_lo[:idx_im_3_lo+1].index[::iv], sp_lo.wluo1[:idx_im_3_lo+1][::iv],'-',color='peru',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='3.5m',ms=12,markevery=mark_every)
    ax[6][0].plot(sp_lo[:idx_im_3_lo+1].index[::iv], sp_lo.wluo0[:idx_im_3_lo+1][::iv],'-',color='maroon',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='4.0m',markevery=mark_every)

    #sp_wlo=prof['grange_4_luo2_wet']['data'].df
    sp_lo=prof['grange_4_luo2_wet']['data'].df
    sp_moi=prof['grange_4_mo_su']['data'].df
    mark_every=24
    iv=100
    ax[7][0].plot(sp_moi[:idx_im_4_mo+1].index[::iv], sp_moi.wluo7[:idx_im_4_mo+1][::iv],'-',color='darkblue',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='0.5m',markevery=mark_every,ms=12)
    ax[7][0].plot(sp_lo[:idx_im_4_lo+1].index[::iv], sp_lo.wluo6[:idx_im_4_lo+1][::iv],'-',color='royalblue',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='1.0m',markevery=mark_every,ms=12)
    ax[7][0].plot(sp_lo[:idx_im_4_lo+1].index[::iv], sp_lo.wluo5[:idx_im_4_lo+1][::iv],'-',color='lightblue',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='1.5m',markevery=mark_every,ms=12)
    ax[7][0].plot(sp_lo[:idx_im_4_lo+1].index[::iv], sp_lo.wluo4[:idx_im_4_lo+1][::iv],'-',color='limegreen',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='2.0m',markevery=mark_every,ms=12)
    ax[7][0].plot(sp_lo[:idx_im_4_lo+1].index[::iv], sp_lo.wluo3[:idx_im_4_lo+1][::iv],'-',color='olive',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='2.5m',markevery=mark_every,ms=12)
    ax[7][0].plot(sp_lo[:idx_im_4_lo+1].index[::iv], sp_lo.wluo2[:idx_im_4_lo+1][::iv],'-',color='gold',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='3.0m',markevery=mark_every,ms=12)
    ax[7][0].plot(sp_lo[:idx_im_4_lo+1].index[::iv], sp_lo.wluo1[:idx_im_4_lo+1][::iv],'-',color='peru',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='3.5m',ms=12,markevery=mark_every)
    ax[7][0].plot(sp_lo[:idx_im_4_lo+1].index[::iv], sp_lo.wluo0[:idx_im_4_lo+1][::iv],'-',color='maroon',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='4.0m',markevery=mark_every)
    ...
    #xlim=[prof['grange_4_luo2_wet']['data'].df.index[0],prof['grange_4_luo2_wet']['data'].df.index[-1]]
   ...
   # ax[3].set_xlim([sp_sch[sch_name].start_dt,sp_sch[sch_name].end_dt])
    ...
    ax[0][0].set_title('(A)',x=0.03,y=0.8,fontweight='bold')
    ax[1][0].set_title('(B)',x=0.03,y=0.8,fontweight='bold')
    ax[2][0].set_title('(C)',x=0.03,y=0.8,fontweight='bold')
    ax[3][0].set_title('(D)',x=0.03,y=0.8,fontweight='bold')
    ax[4][0].set_title('(E)',x=0.03,y=0.8,fontweight='bold')
    ax[5][0].set_title('(F)',x=0.03,y=0.8,fontweight='bold')
    ax[6][0].set_title('(G)',x=0.03,y=0.8,fontweight='bold')
    ax[7][0].set_title('(H)',x=0.03,y=0.8,fontweight='bold')
    ...
    ax[2][0].set_ylim([-1,28])
    ax[3][0].set_ylim([-1,28])
    ax[4][0].set_ylim([-1,28])
    ax[5][0].set_ylim([-1,28])
    ax[6][0].set_ylim([-1,28])
    ax[7][0].set_ylim([-1,28])  
    ...
    #plt.show(block=True) 
    output_name = 'figure/plot_video_oxygen_wet/000'+str(ii)+'.png'
