...
for ii in range(len(date)):
    ...
    idx_im_3_lo = prof['grange_3_luo2_wet']['data'].df.index.get_loc(im_time, method='nearest')
    idx_im_4_lo = prof['grange_4_luo2_wet']['data'].df.index.get_loc(im_time, method='nearest')
    idx_im_5_lo = prof['grange_5_luo2_wet']['data'].df.index.get_loc(im_time, method='nearest')  
    ...
    ax_ox_345.plot(mergedlist_5,depth_y,'-',color='maroon',label='Column_4') 
    ax_ox_345.plot(mergedlist_3,depth_y,'-',color='gold',label='Column_5')
    ax_ox_345.plot(mergedlist_4,depth_y,'-',color='peru',label='Column_6')
