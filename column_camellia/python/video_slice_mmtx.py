...
path_im='/home/chenming/Projects/tailings/column_camellia/'
#import os
...
for ii in file_name:
    ...
    ax[3] = plt.subplot2grid((3, 2), (0, 1), colspan=1)
...
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo0[:idx_im],'o',color='c',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='40mm',markevery=mark_every)
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo1[:idx_im],'ks',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='80mm',ms=12,markevery=mark_every)
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo2[:idx_im],'+',color='brown',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='130mm',markevery=mark_every,ms=12)
...
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo7[:idx_im],'^',color='g',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='300mm',markevery=mark_every,ms=12)
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo8[:idx_im],'x',color='b',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='600mm',markevery=mark_every,ms=12)
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo9[:idx_im],'+',color='m',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='850mm',markevery=mark_every,ms=12)
    
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo0[:idx_im:interval_array],'-',color='c',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='40mmmo0',markevery=mark_every)
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo1[:idx_im:interval_array],'k-',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='80mm1',ms=12,markevery=mark_every)
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo2[:idx_im:interval_array],'-',color='brown',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='130mm2',markevery=mark_every,ms=12)
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo4[:idx_im:interval_array],'-',color='r',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='200mm4',markevery=mark_every,ms=12)
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo7[:idx_im:interval_array],'-',color='g',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='300mm7',markevery=mark_every,ms=12)
#    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo9[:idx_im:interval_array],'-',color='m',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='850mm9',markevery=mark_every,ms=12)
    
    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo0[:idx_im:interval_array],'-',color='c',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='5mm',markevery=mark_every)
    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo7[:idx_im:interval_array],'-',color='g',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='20mm',markevery=mark_every,ms=12)
    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo2[:idx_im:interval_array],'-',color='brown',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='60mm',markevery=mark_every,ms=12)
    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo4[:idx_im:interval_array],'-',color='r',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='110mm',markevery=mark_every,ms=12)
    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo1[:idx_im:interval_array],'k-',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='200mm',ms=12,markevery=mark_every)
    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im:interval_array], sp_sch[sch_name].df.mo9[:idx_im:interval_array],'-',color='m',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='850mm',markevery=mark_every,ms=12)
    #ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo8[:idx_im],'-',color='b',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='600mm',markevery=mark_every,ms=12)
...
#    
    mark_every=1
    ax[2].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.t26_begin[:idx_im],'-',color='c',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='5mm',markevery=mark_every)
    ax[2].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.t45_begin[:idx_im],'-',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='20mm',ms=12,markevery=mark_every)
    ax[2].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.t57_begin[:idx_im],'-',color='brown',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='60mm',markevery=mark_every,ms=12)
    ax[2].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.t7b_begin[:idx_im],'-',color='r',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='110mm',markevery=mark_every,ms=12)
    ax[2].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.te2_begin[:idx_im],'-',color='g',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='200mm',markevery=mark_every,ms=12)
    ax[2].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.tfb_begin[:idx_im],'-',color='b',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='850mm',markevery=mark_every,ms=12)
...
#    ax[3].set_axisbelow(True)
    ...
    ax[3].set_title('(C)',x=0.04,y=0.85,fontweight='bold')
