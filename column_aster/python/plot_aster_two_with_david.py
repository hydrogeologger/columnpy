...
fig.subplots_adjust(left=0.18, right=0.88, top=0.97, bottom=0.08)
...
ax[0].plot(ta['time_days'],ta['cum_evap_m']*constants.m2mm,'-'   ,color='brown',linewidth=lw,markersize=ms,markeredgewidth=mew, markeredgecolor='k',label='load cell')
ax[1].plot(ta['time_days'],ta['evap_rate']*constants.ms2mmday,'-',color='brown',linewidth=lw,markersize=ms,markeredgewidth=mew, markeredgecolor='k',label='load cell')
ax[1].set_ylim([-2,19])


ax[2].plot(ta['time_days'], ta['mom_27'], '-',color='maroon',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='4 cm')
ax[2].plot(ta['time_days'], ta['mom_23'], '-',color='peru',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='8 cm')
ax[2].plot(ta['time_days'], ta['mom_24'], '-',color='gold',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='13cm')
ax[2].plot(ta['time_days'], ta['mom_26'], '-',color='olive',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='20cm')
ax[2].plot(ta['time_days'], ta['mom_28'], '-',color='limegreen',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='30cm')
ax[2].plot(ta['time_days'], ta['mom_25'], '-',color='lightblue',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='45cm')
ax[2].plot(ta['time_days'], ta['mom_30'], '-',color='royalblue',linewidth=lw,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='60cm')
...
ax[3].semilogy(ta['time_days'], ta['su_5_kpa'], 'olive',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='20cm')
ax[3].semilogy(ta['time_days'], ta['su_6_kpa'], 'limegreen',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='30cm')
ax[3].semilogy(ta['time_days'], ta['su_7_kpa'], 'lightblue',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='45cm')
ax[3].semilogy(ta['time_days'], ta['su_8_kpa'], 'royalblue',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='60cm')
ax[3].set_ylim([1,7e2])


ax[4].plot(ta['time_days'], ta['temp_suc1'], '-',color='maroon',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='4 cm')
ax[4].plot(ta['time_days'], ta['temp_suc2'], '-',color='peru',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='8 cm')
ax[4].plot(ta['time_days'], ta['temp_suc3'], '-',color='gold',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='13cm')
ax[4].plot(ta['time_days'], ta['temp_suc4'], '-',color='olive',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='20cm')
ax[4].plot(ta['time_days'], ta['temp_suc5'], '-',color='limegreen',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='30cm')
ax[4].plot(ta['time_days'], ta['temp_suc6'], '-',color='lightblue',linewidth=lw,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='45cm')
ax[4].plot(ta['time_days'], ta['temp_suc7'], '-',color='darkblue',linewidth=lw,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='85cm')
ax[4].set_ylim([7,53])
...
ax[2].legend(bbox_to_anchor=(1.09, 0.5), loc='center', borderaxespad=0.,fontsize=12,handletextpad=0.13,labelspacing=0.05,ncol=1)
...
ax[3].legend(bbox_to_anchor=(1.09, 0.5 ), loc='center', borderaxespad=0.,fontsize=12,handletextpad=0.03,labelspacing=0.02,ncol=1,columnspacing=0.4)
ax[4].legend(bbox_to_anchor=(1.09, 0.5), loc='center', borderaxespad=0.,fontsize=12,handletextpad=0.03,labelspacing=0.02,ncol=1,columnspacing=0.4)#title='CM below surface')
