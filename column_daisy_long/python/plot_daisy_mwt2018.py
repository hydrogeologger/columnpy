...
mark_every=20
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo1,'-',color='r',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='4 cm',markevery=mark_every)
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo2,'-',color='g',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='8 cm',ms=12,markevery=mark_every)
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo3,'-',color='b',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='13cm',markevery=mark_every,ms=12)
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo4,'-',color='c',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='20cm',markevery=mark_every,ms=12)
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo5,'-',color='m',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='30cm',markevery=mark_every,ms=12)
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo7,'-',color='k',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='60cm',markevery=mark_every,ms=12)
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo10,'-',color='brown',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='85cm',markevery=mark_every,ms=12)
