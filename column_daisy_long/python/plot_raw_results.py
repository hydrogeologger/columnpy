...
grid_width=2
y_fontsize=11
fig, ax = plt.subplots(9,sharex=True,figsize=(8,9))
fig.subplots_adjust(hspace=.10)
fig.subplots_adjust(left=0.18, right=0.98, top=0.97, bottom=0.08)
for i in ax:
  for axis in ['top','bottom','left','right']:
    i.spines[axis].set_linewidth(2)
data.df.plot(x='date_time',y='mo1' ,ax=ax[0],style='.',markersize=1)
data.df.plot(x='date_time',y='mo2' ,ax=ax[1],style='.',markersize=1)
data.df.plot(x='date_time',y='mo3' ,ax=ax[2],style='.',markersize=1)
data.df.plot(x='date_time',y='mo4' ,ax=ax[3],style='.',markersize=1)
data.df.plot(x='date_time',y='mo5' ,ax=ax[4],style='.',markersize=1)
data.df.plot(x='date_time',y='mo7' ,ax=ax[5],style='.',markersize=1)
data.df.plot(x='date_time',y='mo10',ax=ax[6],style='.',markersize=1)
#data_weather_daisy.df.plot(x='date_time',y='dlyrainmm',ax=ax[7],style='.',markersize=1)
#data_weather_camellia.df.plot(x='date_time',y='dlyrainmm',ax=ax[7],style='.',markersize=1)
#data_weather_daisy.df.plot(x='date_time',y='rainMaxmm',ax=ax[7],style='.',markersize=1)
#data_weather_camellia.df.plot(x='date_time',y='rainMaxmm',ax=ax[7],style='.',markersize=1)
data_weather_camellia.df.plot.bar(x='date_time',y='rainMaxmm',ax=ax[7])
#data_weather_camellia.df.plot(x='date_time',y='ir_up',ax=ax[8],style='-')
data_weather_daisy.df.plot(x='date_time',y='ir_up',ax=ax[8])

#data_weather_daisy.df.plot(x='date_time',y='dlyrainmm',ax=ax[7],kind='bar')
#data_weather_camellia.df.plot(x='date_time',y='dlyrainmm',ax=ax[7],kind='bar')
...
#ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo2,'-' ,color='peru',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='8 cm',ms=12,markevery=mark_every)
#ax[3].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo3,'-' ,color='gold',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='13cm',markevery=mark_every,ms=12)
#ax[4].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo4,'-' ,color='olive',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='20cm',markevery=mark_every,ms=12)
#ax[5].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo5,'-' ,color='limegreen',markersize=ms-3,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='30cm',markevery=mark_every,ms=12)
#ax[6].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo7,'-' ,color='lightblue',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='60cm',markevery=mark_every,ms=12)
#ax[7].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mo10,'-',color='royalblue',markersize=ms+3,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='85cm',markevery=mark_every,ms=12)
...
ax[2].set_ylim([90,380])
ax[3].set_ylim([90,380])
ax[4].set_ylim([90,380])
ax[5].set_ylim([90,380])
ax[6].set_ylim([90,380])
