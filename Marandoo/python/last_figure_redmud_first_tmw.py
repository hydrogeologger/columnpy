...
#    ax_img.bplot([0.7,0.7,0.1,0.1])
    ...
    ax[0].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.evap_rate_commercial[:idx_im]*constants.ms2mmday,'o',color='c'       ,markersize=ms,markeredgewidth=mew, markeredgecolor='c',label='load cell',markevery=1)
    
    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.sat_commercial[:idx_im]*sp_sch[sch_name].por,'o',color='c',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='Balance',markevery=2)
    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo_9_vwc[:idx_im] ,'kx',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='VWC A',ms=10,markevery=3)
    ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo_10_vwc[:idx_im],'+',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='VWC B',markevery=5,ms=12)
    ...
    ax[2].semilogy(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo_7_suction[:idx_im], 'ko',markersize=ms,markeredgewidth=mew,fillstyle='none', markeredgecolor='black',label='DS A',markevery=3)
    ax[2].semilogy(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo_8_suction[:idx_im], 'x',color='red',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='red',label='DS B',markevery=4,ms=12)
    ax[2].semilogy(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.suht_2896_suction[:idx_im], '+',color='green',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='green',label='TS C',markevery=5,ms=12)
