...
if plot_moisture_calibration:
    ...
    #aa=-3.0
    aa=-0.5
    ax[0][0].plot(sp_sch[sch_name].df['norm_t_1'], np.log(sp_sch[sch_name].df ['suc_scale1']),   'o',mfc='none' ,markeredgecolor='r',markersize=ms,markeredgewidth=mew,fillstyle='full',label= 'Dielectric moisture sensor A,\nred mud experiment 1',markevery=2) 
    ...
    ax[0][0].plot(dp, sp_sch[sch_name].su1_fit1[0]*dp+sp_sch[sch_name].su1_fit1[1],color='r',linewidth=lw,label='bb') 
    ...
    ax[0][0].plot(dp, (dp**aa-0.01**aa)/(1.**aa-0.01**aa)*13.5,color='r',linewidth=lw,label='bb', linestyle='--')

    ax[0][1].plot(sp_sch[sch_name].df['norm_t_2'],np.log(sp_sch[sch_name].df ['suc_scale2']),    's',mfc='none' ,markeredgecolor='g',markersize=ms,markeredgewidth=mew,fillstyle='full',label= 'Dielectric moisture sensor A,\nred mud experiment 1',markevery=2) 
    #ax[0][1].plot(dp, sp_sch[sch_name].vw2_fit_a*dp+sp_sch[sch_name].vw2_fit_b,color='g',linewidth=lw,label='bb') 
    ax[0][1].plot(dp, sp_sch[sch_name].su2_fit1[0]*dp+sp_sch[sch_name].su2_fit1[1],color='g',linewidth=lw,label='bb') 
    ax[0][1].plot(dp, (dp**aa-0.01**aa)/(1.**aa-0.01**aa)*13.5,color='g',linewidth=lw,label='bb', linestyle='--')

    ax[1][0].plot(sp_sch[sch_name].df['norm_t_3'],np.log(sp_sch[sch_name].df ['suc_scale3']),    'v',mfc='none' ,markeredgecolor='c',markersize=ms,markeredgewidth=mew,fillstyle='full',label= 'Dielectric moisture sensor A,\nred mud experiment 1',markevery=2) 
    ax[1][0].plot(dp, sp_sch[sch_name].su3_fit1[0]*dp+sp_sch[sch_name].su3_fit1[1],color='c',linewidth=lw,label='bb') 
    ax[1][0].plot(dp, (dp**aa-0.01**aa)/(1.**aa-0.01**aa)*13.5,color='c',linewidth=lw,label='bb', linestyle='--')

    #ax[1][0].plot(dp, sp_sch[sch_name].vw3_fit_a*dp+sp_sch[sch_name].vw3_fit_b,color='c',linewidth=lw,label='bb') 
    sch_name='Marandoo_third'
    ax[1][1].plot(sp_sch[sch_name].df['norm_t_1'],np.log(sp_sch[sch_name].df ['suc_scale1']),    'x',mfc='none' ,markeredgecolor='brown',markersize=ms,markeredgewidth=mew,fillstyle='full',label= 'Dielectric moisture sensor A,\nred mud experiment 1',markevery=2) 
    ax[1][1].plot(dp, sp_sch[sch_name].su1_fit1[0]*dp+sp_sch[sch_name].su1_fit1[1],color='brown',linewidth=lw,label='bb') 
    ax[1][1].plot(dp, (dp**aa-0.01**aa)/(1.**aa-0.01**aa)*13.5,color='brown',linewidth=lw,label='bb', linestyle='--')

    #ax[1][1].plot(dp, sp_sch[sch_name].vw1_fit_a*dp+sp_sch[sch_name].vw1_fit_b,color='brown',linewidth=lw,label='bb') 
    sch_name='Marandoo_second'
    ax[2][0].plot(sp_sch[sch_name].df['norm_t_2'],np.log(sp_sch[sch_name].df ['suc_scale2']),    '^',mfc='none' ,markeredgecolor='k',markersize=ms,markeredgewidth=mew,fillstyle='full',label= 'Dielectric moisture sensor A,\nred mud experiment 1',markevery=2) 
    ax[2][0].plot(dp, sp_sch[sch_name].su2_fit1[0]*dp+sp_sch[sch_name].su2_fit1[1],color='k',linewidth=lw,label='bb') 
    ax[2][0].plot(dp, (dp**aa-0.01**aa)/(1.**aa-0.01**aa)*13.5,color='k',linewidth=lw,label='bb', linestyle='--')
    #ax[2][0].plot(dp, sp_sch[sch_name].vw2_fit_a*dp+sp_sch[sch_name].vw2_fit_b,color='k',linewidth=lw,label='bb') 
    ax[2][1].plot(sp_sch[sch_name].df['norm_t_3'],np.log(sp_sch[sch_name].df ['suc_scale3']),    'd',mfc='none' ,markeredgecolor='b',markersize=ms,markeredgewidth=mew,fillstyle='full',label= 'Dielectric moisture sensor A,\nred mud experiment 1',markevery=2) 
    ax[2][1].plot(dp, sp_sch[sch_name].su3_fit1[0]*dp+sp_sch[sch_name].su3_fit1[1],color='b',linewidth=lw,label='bb') 
    ax[2][1].plot(dp, (dp**aa-0.01**aa)/(1.**aa-0.01**aa)*13.5,color='b',linewidth=lw,label='bb', linestyle='--')
