...
#    print(file)
path_im='/home/chenming/Projects/tailings/area_51_coal_4cm_photo_2/'
...
#    ax_img.bplot([0.7,0.7,0.1,0.1])
    ...
    ax[3].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo_9[:idx_im] ,'ko',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='Dielectric moisture A')
    ax[3].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.mo_10[:idx_im],'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Dielectric moisture B')
    ...
    ax[5].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.suht_28e5_begin[:idx_im], 'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Fred. Suc. A')
    
    ax[6].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.norm_delta_t_28e5_heat[:idx_im], 'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Fredlund suction A')
    ax[6].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.norm_delta_t_2847_heat[:idx_im], 'ko',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='Fredlund suction B')
    ...
    ax[7].semilogy(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.saltrh_3_suction[:idx_im],'ko',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='Temp.&Hum. B')
    ...
    ax[3].legend(bbox_to_anchor=(.6, 0.4), loc=2, borderaxespad=0.)
    ax[4].legend(bbox_to_anchor=(.6, 0.6 ), loc=2, borderaxespad=0.)
    ax[6].legend(bbox_to_anchor=(.5, 0.75 ), loc=2, borderaxespad=0.)
    ax[7].legend(bbox_to_anchor=(.7, 0.55 ), loc=2, borderaxespad=0.)
    ...
    fig.savefig('plot_calibrated_result'+sch_name+ii+'.png', format='png', dpi=200)
    plt.close()
