...
ax[5].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.suht_28e5_begin, 'ko',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='Fred. Suc. A')

ax[6].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.norm_delta_t_2847_heat, 'ko',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='Fred. Suc. A')
...
ax[7].semilogy(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.saltrh_3_suction,'bo',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='Temp.&Hum. B')
