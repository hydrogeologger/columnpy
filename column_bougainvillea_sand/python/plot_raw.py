...
data.df['su4'][  data.df['ssu_4'].values>15] =np.nan
data.df['su5'][  data.df['ssu_5'].values>15] =np.nan
data.df['su6'][  data.df['ssu_6'].values>15] =np.nan
data.df['su7'][  data.df['ssu_7'].values>15] =np.nan
data.df['su8'][  data.df['ssu_8'].values>15] =np.nan
data.df['su4'][  data.df['ssu_4'].values<-1] =np.nan
data.df['su5'][  data.df['ssu_5'].values<-1] =np.nan
data.df['su6'][  data.df['ssu_6'].values<-1] =np.nan
data.df['su7'][  data.df['ssu_7'].values<-1] =np.nan
data.df['su8'][  data.df['ssu_8'].values<-1] =np.nan
#data.df['mom_27'][  data.df['mom_27'].values<300] =np.nan
data.df['temp_suc1'][  data.df['temp_suc1'].values<10] =np.nan
data.df['temp_suc2'][  data.df['temp_suc2'].values<10] =np.nan
data.df['temp_suc3'][  data.df['temp_suc3'].values<10] =np.nan
data.df['temp_suc4'][  data.df['temp_suc4'].values<10] =np.nan
data.df['temp_suc5'][  data.df['temp_suc5'].values<10] =np.nan
data.df['temp_suc6'][  data.df['temp_suc6'].values<10] =np.nan
data.df['temp_suc7'][  data.df['temp_suc7'].values<10] =np.nan
data.df['temp_suc8'][  data.df['temp_suc8'].values<10] =np.nan
data.df['temp_suc1'][  data.df['temp_suc1'].values>100] =np.nan
data.df['temp_suc2'][  data.df['temp_suc2'].values>100] =np.nan
data.df['temp_suc3'][  data.df['temp_suc3'].values>100] =np.nan
data.df['temp_suc4'][  data.df['temp_suc4'].values>100] =np.nan
data.df['temp_suc5'][  data.df['temp_suc5'].values>100] =np.nan
data.df['temp_suc6'][  data.df['temp_suc6'].values>100] =np.nan
data.df['temp_suc7'][  data.df['temp_suc7'].values>100] =np.nan
data.df['temp_suc8'][  data.df['temp_suc8'].values>100] =np.nan
...
ax[0].plot(data.df['date_time'], data.df['balance_bottom'], 'o' ,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Moisture A')


ax[1].plot(data.df['date_time'], data.df['mom_3'], 'ro',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A')
ax[1].plot(data.df['date_time'], data.df['mom_4'], 'go',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='Dielectric suction B')
ax[1].plot(data.df['date_time'], data.df['mom_5'], 'bo',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='Moisture A')
ax[1].plot(data.df['date_time'], data.df['mom_6'], 'co',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='Moisture A')
ax[1].plot(data.df['date_time'], data.df['mom_7'], 'mo',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='Moisture A')
ax[1].plot(data.df['date_time'], data.df['mom_8'], 'ko',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='Moisture A')
#ax[1].plot(data.df['date_time'], data.df['mo0'], 'o' ,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Moisture A')
#ax[1].plot(data.df['date_time'], data.df['mo8'], 'o' ,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Moisture A')
#ax[1].plot(data.df['date_time'], data.df['mo9'], 'o' ,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Moisture A')



#ax[2].plot(data.df['date_time'], data.df['ssu_3'], 'ro',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A')
ax[2].plot(data.df['date_time'], data.df['ssu_4'], 'ro',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Dielectric suction A')
ax[2].plot(data.df['date_time'], data.df['ssu_5'], 'go',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='g',label='Dielectric suction B')
ax[2].plot(data.df['date_time'], data.df['ssu_6'], 'bo',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='b',label='Moisture A')
ax[2].plot(data.df['date_time'], data.df['ssu_7'], 'co',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='c',label='Moisture A')
ax[2].plot(data.df['date_time'], data.df['ssu_8'], 'mo',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='m',label='Moisture A')
#ax[2].plot(data.df['date_time'], data.df['suction6'], 'ko',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='k',label='Moisture A')
#ax[2].plot(data.df['date_time'], data.df['suction7'], 'o' ,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Moisture A')
...
ax[3].plot(data.df['date_time'], data.df['temp_suc8'], 'o' ,markerfacecolor='brown' ,markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Moisture A')
