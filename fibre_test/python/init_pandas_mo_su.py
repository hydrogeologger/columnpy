...
data_file_path=current_path+'/data/public_fibre_test/'    # warning, all the files should be .dat DO NOT FORGET THE LAST SLASH
...
data_mo_su.df['tempa1_a'].loc[data_mo_su.df['tempa1_a']<1]=np.nan;
data_mo_su.df['tempa1_b'].loc[data_mo_su.df['tempa1_b']<1]=np.nan;
data_mo_su.df['tempa2_a'].loc[data_mo_su.df['tempa2_a']<1]=np.nan;
data_mo_su.df['tempa2_b'].loc[data_mo_su.df['tempa2_b']<1]=np.nan;
data_mo_su.df['tempa3_a'].loc[data_mo_su.df['tempa3_a']<1]=np.nan;
data_mo_su.df['tempa3_b'].loc[data_mo_su.df['tempa3_b']<1]=np.nan;
data_mo_su.df['tempb1_a'].loc[data_mo_su.df['tempb1_a']<1]=np.nan;
data_mo_su.df['tempb1_b'].loc[data_mo_su.df['tempb1_b']<1]=np.nan;
data_mo_su.df['tempb2_a'].loc[data_mo_su.df['tempb2_a']<1]=np.nan;
data_mo_su.df['tempb2_b'].loc[data_mo_su.df['tempb2_b']<1]=np.nan;
data_mo_su.df['tempb3_a'].loc[data_mo_su.df['tempb3_a']<1]=np.nan;
data_mo_su.df['tempb3_b'].loc[data_mo_su.df['tempb3_b']<1]=np.nan;
data_mo_su.df['tempc1_a'].loc[data_mo_su.df['tempc1_a']<1]=np.nan;
data_mo_su.df['tempc1_b'].loc[data_mo_su.df['tempc1_b']<1]=np.nan;
data_mo_su.df['tempc2_a'].loc[data_mo_su.df['tempc2_a']<1]=np.nan;
data_mo_su.df['tempc2_b'].loc[data_mo_su.df['tempc2_b']<1]=np.nan;
data_mo_su.df['tempc3_a'].loc[data_mo_su.df['tempc3_a']<1]=np.nan;
data_mo_su.df['tempc3_b'].loc[data_mo_su.df['tempc3_b']<1]=np.nan;
...
####   special treatment
#time_start=np.datetime64('2019-04-24 12:00')
#time_end=np.datetime64('2019-07-17 17:00')
#mask=data_mo_su.df['timestamp'].between(time_start,time_end)
...
#time_start_scale1=np.datetime64('2019-04-24 12:00')
#data_mo_su.df['scale1'].loc[time_start_scale1:]=np.nan
...
#
time_start=np.datetime64('2019-06-09T14:00')
#time_end for scale 2 and 3 is '2019-05-07T10:45'
time_end=np.datetime64('2019-05-07T10:45')
#time_end=np.datetime64('2019-05-05T10:45')
##https://stackoverflow.com/questions/31617845/how-to-select-rows-in-a-dataframe-between-two-values-in-python-pandas/
#data_mo_su.df['date_time']=data_mo_su.df['timestamp']
#mask=data_mo_su.df['date_time'].between(:time_end)
#data_mo_su.df['mob1'][mask]=np.nan;
#data_mo_su.df['mob2'][mask]=np.nan;
#data_mo_su.df['mob3'][mask]=np.nan;
#data_mo_su.df['sub1'][mask]=np.nan;
#data_mo_su.df['sub2'][mask]=np.nan;
#data_mo_su.df['sub3'][mask]=np.nan;
#data_mo_su.df['moc1'][mask]=np.nan;
#data_mo_su.df['moc2'][mask]=np.nan;
#data_mo_su.df['moc3'][mask]=np.nan;
#data_mo_su.df['suc1'][mask]=np.nan;
#data_mo_su.df['suc2'][mask]=np.nan;
#data_mo_su.df['suc3'][mask]=np.nan;
data_mo_su.df['scale2'].loc[:time_end]=np.nan;
data_mo_su.df['scale2'].loc[time_start:]=np.nan;
data_mo_su.df['scale3'].loc[:time_end]=np.nan;
data_mo_su.df['scale3'].loc[time_start:]=np.nan;
#data_mo_su.df['scale3'][mask]=np.nan;
#data_mo_su.df['tempb1_a'][mask]=np.nan;
#data_mo_su.df['tempb1_b'][mask]=np.nan;
#data_mo_su.df['tempb2_a'][mask]=np.nan;
#data_mo_su.df['tempb2_b'][mask]=np.nan;
data_mo_su.df['mob1'].loc[:time_end]=np.nan;
data_mo_su.df['mob1'].loc[time_start:]=np.nan;
data_mo_su.df['mob2'].loc[:time_end]=np.nan;
data_mo_su.df['mob2'].loc[time_start:]=np.nan;
data_mo_su.df['mob3'].loc[:time_end]=np.nan;
data_mo_su.df['mob3'].loc[time_start:]=np.nan;
data_mo_su.df['moc1'].loc[:time_end]=np.nan;
data_mo_su.df['moc1'].loc[time_start:]=np.nan;
data_mo_su.df['moc2'].loc[:time_end]=np.nan;
data_mo_su.df['moc2'].loc[time_start:]=np.nan;
data_mo_su.df['moc3'].loc[:time_end]=np.nan;
data_mo_su.df['moc3'].loc[time_start:]=np.nan;

data_mo_su.df['sub1'].loc[:time_end]=np.nan;
data_mo_su.df['sub1'].loc[time_start:]=np.nan;
data_mo_su.df['sub2'].loc[:time_end]=np.nan;
data_mo_su.df['sub2'].loc[time_start:]=np.nan;
data_mo_su.df['sub3'].loc[:time_end]=np.nan;
data_mo_su.df['sub3'].loc[time_start:]=np.nan;
data_mo_su.df['suc1'].loc[:time_end]=np.nan;
data_mo_su.df['suc1'].loc[time_start:]=np.nan;
data_mo_su.df['suc2'].loc[:time_end]=np.nan;
data_mo_su.df['suc2'].loc[time_start:]=np.nan;
data_mo_su.df['suc3'].loc[:time_end]=np.nan;
data_mo_su.df['suc3'].loc[time_start:]=np.nan;

data_mo_su.df['tempb1_a'].loc[:time_end]=np.nan;
data_mo_su.df['tempb1_a'].loc[time_start:]=np.nan;
data_mo_su.df['tempb2_a'].loc[:time_end]=np.nan;
data_mo_su.df['tempb2_a'].loc[time_start:]=np.nan;
data_mo_su.df['tempb3_a'].loc[:time_end]=np.nan;
data_mo_su.df['tempb3_a'].loc[time_start:]=np.nan;
data_mo_su.df['tempb1_b'].loc[:time_end]=np.nan;
data_mo_su.df['tempb1_b'].loc[time_start:]=np.nan;
data_mo_su.df['tempb2_b'].loc[:time_end]=np.nan;
data_mo_su.df['tempb2_b'].loc[time_start:]=np.nan;
data_mo_su.df['tempb3_b'].loc[:time_end]=np.nan;
data_mo_su.df['tempb3_b'].loc[time_start:]=np.nan;
data_mo_su.df['tempb1_a'].loc[:time_end]=np.nan;
data_mo_su.df['tempc1_a'].loc[time_start:]=np.nan;
data_mo_su.df['tempc2_a'].loc[:time_end]=np.nan;
data_mo_su.df['tempc2_a'].loc[time_start:]=np.nan;
data_mo_su.df['tempc3_a'].loc[:time_end]=np.nan;
data_mo_su.df['tempc3_a'].loc[time_start:]=np.nan;
data_mo_su.df['tempc1_b'].loc[:time_end]=np.nan;
data_mo_su.df['tempc1_b'].loc[time_start:]=np.nan;
data_mo_su.df['tempc2_b'].loc[:time_end]=np.nan;
data_mo_su.df['tempc2_b'].loc[time_start:]=np.nan;
data_mo_su.df['tempc3_b'].loc[:time_end]=np.nan;
data_mo_su.df['tempc3_b'].loc[time_start:]=np.nan;
#data_mo_su.df.loc[mask,'mob2']=np.nan;
#data_mo_su.df.loc[mask,'mob3']=np.nan;
#data_mo_su.df.loc[mask,'moc1']=np.nan;
#data_mo_su.df.loc[mask,'moc2']=np.nan;
#data_mo_su.df.loc[mask,'moc3']=np.nan;
#data_mo_su.df.loc[mask,'scale2']=np.nan;
#data_mo_su.df.loc[mask,'scale3']=np.nan;
#data_mo_su.df.loc[mask,'sub1']=np.nan;
#data_mo_su.df.loc[mask,'sub2']=np.nan;
#data_mo_su.df.loc[mask,'sub3']=np.nan;
#data_mo_su.df.loc[mask,'suc1']=np.nan;
#data_mo_su.df.loc[mask,'suc2']=np.nan;
#data_mo_su.df.loc[mask,'suc3']=np.nan;
#data_mo_su.df.loc[mask,'tempb1_a']=np.nan;
#data_mo_su.df.loc[mask,'tempb1_b']=np.nan;
#data_mo_su.df.loc[mask,'tempb2_a']=np.nan;
#data_mo_su.df.loc[mask,'tempb2_b']=np.nan;
#data_mo_su.df.loc[mask,'tempb3_a']=np.nan;
#data_mo_su.df.loc[mask,'tempb3_b']=np.nan;
#data_mo_su.df.loc[mask,'tempc1_a']=np.nan;
#data_mo_su.df.loc[mask,'tempc1_b']=np.nan;
#data_mo_su.df.loc[mask,'tempc2_a']=np.nan;
#data_mo_su.df.loc[mask,'tempc2_b']=np.nan;
#data_mo_su.df.loc[mask,'tempc3_a']=np.nan;
#data_mo_su.df.loc[mask,'tempc3_b']=np.nan;
