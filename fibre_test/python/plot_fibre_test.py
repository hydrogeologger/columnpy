...
sch_name='fibre_test_first_cycle'
#ax[0].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.cum_evap_scale1*constants.m2mm, '-',color='brown'  ,markersize=ms,markeredgewidth=mew, markeredgecolor='brown'  ,label='No_fibres_basin',markevery=1)
#ax[0].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.cum_evap_scale2*constants.m2mm, '-',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',label='Black_fibres_1%',markevery=2)
ax[0].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.cum_evap_scale3*constants.m2mm, '-',color='greenyellow',markersize=ms,markeredgewidth=mew, markeredgecolor='greenyellow',label='Red_fibre_1%',markevery=2)
...
#ax[1].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.evap_rate_scale1*constants.ms2mmday,'-',color='brown'  ,markersize=ms,markeredgewidth=mew, markeredgecolor='brown'  ,label='No_fibres_basin)',markevery=1)
#ax[1].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.evap_rate_scale2*constants.ms2mmday,'-',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',label='Black_fibres_1%',markevery=2)
ax[1].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.evap_rate_scale3*constants.ms2mmday,'-',color='greenyellow',markersize=ms,markeredgewidth=mew, markeredgecolor='greenyellow',label='Red_fibre_1%',markevery=2)
#sch_name='bacteria_second'
...
#sch_name='bacteria_first'
#ax[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.mmoa1,'-',color='red',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='red',label='Moa1')
#ax[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.mmoa2,'-',color='yellow',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='yellow',label='Moa2')
...
# this script is used for calibrating load cellsx[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.mmob1,'-',color='cyan',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='cyan',label='Mob1(10k)')
#ax[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.mmob1,'-',color='cyan',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='cyan',label='Mob1')
#ax[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.mmob2,'-',color='gold',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='gold',label='Mob2')
...
ax[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.mmoc1,'-',color='blue',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='blue',label='Moc1')
ax[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.mmoc2,'-',color='purple',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='purple',label='Moc2')
...
#ax[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.sat_scale1,'-',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='No_fibres_basin')
#ax[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.sat_scale2,'-',color='orange',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='orange',label='Black_fibres_1%')
ax[2].plot(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.sat_scale3,'-',color='greenyellow',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='greenyellow',label='Red_fibres_1%')
...
#ax[3].semilogy(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.suctionb2,'-',color='yellow',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='yellow',label='Sub2')
...
#ax[3].semilogy(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.suc_scale1,'-',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='No_fibres_basin')
#ax[3].semilogy(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.suc_scale2,'-',color='orange',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='orange',label='Black_fibre_1%')
ax[3].semilogy(sp_sch[sch_name].df['date_time'], sp_sch[sch_name].df.suc_scale3,'-',color='greenyellow',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='greenyellow',label='Red_fibre_1%')
#sch_name='bacteria_second'
...
fig.savefig('figure/plot_fibre_test'+sch_name+'.png', format='png', dpi=500)
