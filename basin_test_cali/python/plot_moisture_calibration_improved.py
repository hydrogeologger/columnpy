...
#
    ...
    ax[0][0].set_title('(A) Moisture sensor a1',x=0.45,y=0.88,fontweight='bold',fontsize=13,horizontalalignment='left')
    ax[0][1].set_title('(B) Moisture sensor a3',x=0.45,y=0.88,fontweight='bold',fontsize=13,horizontalalignment='left')
    ax[1][0].set_title('(C) Moisture sensor b1',x=0.45,y=0.88,fontweight='bold',fontsize=13,horizontalalignment='left')
    ax[1][1].set_title('(D) Moisture sensor b2',x=0.45,y=0.88,fontweight='bold',fontsize=13,horizontalalignment='left')
    ax[2][0].set_title('(E) Moisture sensor b3',x=0.45,y=0.88,fontweight='bold',fontsize=13,horizontalalignment='left')
    ax[2][1].set_title('(F) Moisture sensor c1',x=0.45,y=0.88,fontweight='bold',fontsize=13,horizontalalignment='left')
    ax[3][0].set_title('(E) Moisture sensor c2',x=0.45,y=0.88,fontweight='bold',fontsize=13,horizontalalignment='left')
    ax[3][1].set_title('(F) Moisture sensor c3',x=0.45,y=0.88,fontweight='bold',fontsize=13,horizontalalignment='left')
    ...
    ax[0][0].set_ylabel('DEGREE OF\nSATURATION', fontsize=y_fontsize, labelpad=5)
    ax[1][0].set_ylabel('DEGREE OF\nSATURATION', fontsize=y_fontsize, labelpad=5)
    ax[2][0].set_ylabel('DEGREE OF\nSATURATION', fontsize=y_fontsize, labelpad=5)
    ax[3][0].set_ylabel('DEGREE OF\nSATURATION', fontsize=y_fontsize, labelpad=5)
    ...
    ax[0][0].legend(bbox_to_anchor=(0.45  , 0.88 ), loc=2, borderaxespad=0.,fontsize=10.5,handletextpad=0.73,labelspacing=0.35,handlelength=2.5)
    ax[0][1].legend(bbox_to_anchor=(0.45  , 0.88 ), loc=2, borderaxespad=0.,fontsize=10.5,handletextpad=0.73,labelspacing=0.35,handlelength=2.5)
    ax[1][0].legend(bbox_to_anchor=(0.45  , 0.88 ), loc=2, borderaxespad=0.,fontsize=10.5,handletextpad=0.73,labelspacing=0.35,handlelength=2.5)
    ax[1][1].legend(bbox_to_anchor=(0.45  , 0.88 ), loc=2, borderaxespad=0.,fontsize=10.5,handletextpad=0.73,labelspacing=0.35,handlelength=2.5)
    ax[2][0].legend(bbox_to_anchor=(0.45  , 0.88 ), loc=2, borderaxespad=0.,fontsize=10.5,handletextpad=0.73,labelspacing=0.35,handlelength=2.5)
    ax[2][1].legend(bbox_to_anchor=(0.45  , 0.88 ), loc=2, borderaxespad=0.,fontsize=10.5,handletextpad=0.73,labelspacing=0.35,handlelength=2.5)
    ax[3][0].legend(bbox_to_anchor=(0.45  , 0.88 ), loc=2, borderaxespad=0.,fontsize=10.5,handletextpad=0.73,labelspacing=0.35,handlelength=2.5)
    ax[3][1].legend(bbox_to_anchor=(0.45  , 0.88 ), loc=2, borderaxespad=0.,fontsize=10.5,handletextpad=0.73,labelspacing=0.35,handlelength=2.5)

    
    plt.show(block=False)
    
    fig.savefig('figure/improved/plot_moisture_calibration.png', format='png', dpi=300)
