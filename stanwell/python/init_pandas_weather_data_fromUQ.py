...
#data_settlement_path=current_path+'/data/manual/manual_for_merge/update/'    #This path is for the Final report settlement data * warning, all the files should be .dat*
data_settlement_path=current_path+'/data/manual/manual_for_merge/update/for_paper/'    # This path is for the stanwell paper **warning, all the files should be .dat*
