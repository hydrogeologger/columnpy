...
ax[1].set_xlabel('VOLUMETRIC\nMOISTURE CONTENT (m$^3$/m$^3$)',fontsize=y_fontsize,labelpad=4)
ax[0].set_ylabel('DEPTH RELATIVE TO\nTHE INITIAL COLUMN SURFACE (mm)',fontsize=y_fontsize,labelpad=3)
...
depth_y=np.array([15,50,80,135,200,285,385,485,700,850])
...
fig.savefig('figure/figures_for_paper/plot_profile1.png', format='png', dpi=300)
#fig.savefig('figure/update/update_toJan2021/final_report/plot_profile1.png', format='png', dpi=300)
...
#--------------Below is the period 5 for the final report-----------------------------
#with open('input/plot_profile5_final.json') as f:
#        plt_profile_5 = json.load(f,object_pairs_hook=collections.OrderedDict)
#
#for i in plt_profile_5['time']:
#   plt_profile_5['time64'][i]  =pd.to_datetime(plt_profile_5['time'][i])
...
ax[0].legend(bbox_to_anchor=(0.008, 0.01 ), loc='lower left', borderaxespad=0.,fontsize=legend_fsz,handletextpad=0.1,labelspacing=0.1,ncol=1,columnspacing=0.2)
ax[1].legend(bbox_to_anchor=(0.995, 0.99 ), loc='upper right', borderaxespad=0.,fontsize=legend_fsz,handletextpad=0.1,labelspacing=0.1,ncol=2,columnspacing=0.1)
#ax[2].legend(bbox_to_anchor=(0.008, 0.01 ), loc='lower left', borderaxespad=0.,fontsize=legend_fsz,handletextpad=0.1,labelspacing=0.1,ncol=1,columnspacing=0.2)
ax[2].legend(bbox_to_anchor=(0.995, 0.99 ), loc='upper right', borderaxespad=0.,fontsize=legend_fsz,handletextpad=0.1,labelspacing=0.1,ncol=2,columnspacing=0.1)
...
fig.savefig('figure/figures_for_paper/plot_profile2.png', format='png', dpi=300)
#fig.savefig('figure/update/update_toJan2021/final_report/plot_profile2.png', format='png', dpi=300)
#plt.close()
