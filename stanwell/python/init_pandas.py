...
time_start_pre1=np.datetime64('2018-08-27 02:00')
time_start1_pre1=np.datetime64('2018-09-15 12:00')
time_rainstart_pre1=np.datetime64('2018-10-06 12:00')
time_rainend_pre1=np.datetime64('2018-10-16 20:00')
...
data.df['pre1'][mask]=np.random.randint(1035,1045,size=54)
data.df['pre1'][mask0]=np.random.randint(1030,1050,size=267)
data.df['pre1'][mask1]=np.random.randint(1040,1055,size=76)
data.df['pre1'][mask2]=np.random.randint(1025,1045,size=168)

time_start_pre0=np.datetime64('2018-07-18 13:00')
time_dry_pre0=np.datetime64('2018-08-25 12:00')
time_end_pre0=np.datetime64('2019-03-04 06:00')
...
time_start_tmp2=np.datetime64('2018-11-13 12:40')
time_end_tmp2=np.datetime64('2018-12-15 04:00')
time_rainst_tmp2=np.datetime64('2018-12-16 06:00')
time_rainsp_tmp2=np.datetime64('2019-01-06 06:00')
time_last_tmp2=np.datetime64('2019-03-04 06:00')
