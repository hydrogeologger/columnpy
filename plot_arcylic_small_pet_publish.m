...
text(1,44,'(a)','fontweight','bold','fontsize',a.fs_ylabel)
...
text(1,1.15,'(b)','fontweight','bold','fontsize',a.fs_ylabel)
axis([0,30,-0.2,1.2])
grid on
...
text(1,115,'(c)','fontweight','bold','fontsize',a.fs_ylabel)
...
set(gca,'FontSize',12,'FontWeight','bold','linewidth',2)
text(1,9.5,'(d)','fontweight','bold','fontsize',a.fs_ylabel)
grid on
savefig(h,file_name)
