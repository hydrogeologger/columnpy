...
path_im='C:\Project\MBDA\stationphoto\sa2'
...
for ii in file_name: #[0:3]:
    ...
    im_sa3=image.imread(file_name_sa3[j])
...
<<<<<<< HEAD
    ...
    ax[2] = plt.subplot2grid((8, 5), (2, 0), colspan=3)
    ax[3] = plt.subplot2grid((8, 5), (3, 0), colspan=3)
    ax[4] = plt.subplot2grid((8, 5), (4, 0), colspan=3)
    ax[5] = plt.subplot2grid((8, 5), (5, 0), colspan=3)
...
<<<<<<< HEAD
    ...
    ax[2].plot( sp_sch.df.index, sp_sch.df['recharge_mmPday_p2'])
    ...
    ax[3].plot( sp_sch.df.index, (sp_sch.df['p2_cs451']-0.34-0.2213+0.032) * constants.mmPm  )    
...
>>>>>>> d9364ad48934113369a343d40db53b05b0166ff6
    ...
    ax[0].legend(bbox_to_anchor=(1.07, 0.5 ), loc='center', 
    ...
    ax[5].legend(bbox_to_anchor=(1.07, 0.5 ), loc='center', 
      borderaxespad=0.,fontsize=15,handletextpad=0.23,labelspacing=0.22,
      ncol=1,columnspacing=0.4)    
    ax[6].legend(bbox_to_anchor=(1.07, 0.5 ), loc='center', 
      borderaxespad=0.,fontsize=15,handletextpad=0.23,labelspacing=0.22,
      ncol=1,columnspacing=0.4)    
    ax[7].legend(bbox_to_anchor=(1.10, 0.5 ), loc='center', 
      borderaxespad=0.,fontsize=15,handletextpad=0.23,labelspacing=0.22,
      ncol=1,columnspacing=0.4)    
    # plt.tight_layout()
