...
path_im_nobact='/home/osboxes/bact1/'
...
path_im_bact='/home/osboxes/bact2/'
...
#for ii in file_name:
   ...
   # idx_im, min_value = min(enumerate( abs(sp_sch[sch_name].df['date_time']-im_time)), key=operator.itemgetter(1)) 
    ...
    fig.subplots_adjust(left=0.07, right=0.93, top=0.97, bottom=0.1)
    ...
    #ax[0].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.cum_evap_scale1[:idx_im]*constants.m2mm,'o',color='brown'  ,markersize=ms,markeredgewidth=mew, markeredgecolor='brown'  ,label='Basin1',markevery=1)
    #ax[0].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.cum_evap_scale2[:idx_im]*constants.m2mm,'s',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',label='Basin2',markevery=2)
    ...
    #sch_name='bacteria_first'
    #ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.evap_rate_scale1[:idx_im]*constants.ms2mmday,'o',color='brown'  ,markersize=ms,markeredgewidth=mew, markeredgecolor='brown'  ,label='Basin1',markevery=1)
    #ax[1].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.evap_rate_scale2[:idx_im]*constants.ms2mmday,'s',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',label='Basin2',markevery=2)
    sch_name='bacteria_second'
    ...
    #sch_name='bacteria_first'
    #ax[3].semilogy(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.suc_scale1[:idx_im],'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Basin1')
    #ax[3].semilogy(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.suc_scale2[:idx_im],'o',color='orange',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='orange',label='Basin2')
    sch_name='bacteria_second'
   ...
   # ax[3].set_ylim([-0.1,1.1])    
    ...
    ax[2].set_ylabel('DEGREE OF\nSATURATION', fontsize=y_fontsize, labelpad=25)
