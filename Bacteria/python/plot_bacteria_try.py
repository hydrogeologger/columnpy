...
ax[0].set_ylim([0,30])
#ax[1].plot(ta['date_time'],ta['evap_rate_scale1'],'r-',linewidth=lw,markersize=ms,markeredgewidth=mew, markeredgecolor='g',label='scale 1')
#ax[1].set_ylim([0,5.7])
...
#ax[0].plot(ta['date_time'], ta['rainmm'], '-',color='maroon',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='Cumulative evaporation')
#ax[0].set_ylim([-5,30])
...
#ax[4].plot(ta['date_time'], ta['sat_scale1'], '-',color='olive',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='basin 1')
#ax[4].plot(ta['date_time'], ta['sat_scale2'], '-',color='royalblue',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='r',label='basin 2')
#ax[4].set_ylim([-0.2,1.7])
...
ax[2].set_ylabel('SUCTION\n(kPa)', fontsize=y_fontsize, labelpad=5)
#ax[2].set_ylabel('TEMPERATURE\nFROM\nSUCTION SENSORS\n($^\circ$C)', fontsize=y_fontsize, labelpad=5)
#ax[3].set_ylabel('DIELECTRIC\nPERMITIVITY', fontsize=y_fontsize, labelpad=13)
ax[3].set_ylabel('DEGREE OF\nSATURATION', fontsize=y_fontsize, labelpad=7)
...
fig.savefig('figure/plot_bacteria.png', format='png', dpi=600)
