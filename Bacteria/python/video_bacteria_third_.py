...
path_im_nobact=os.environ['nobact_exp3']
...
path_im_bact=os.environ['bact_exp3']
...
#for ii in file_name_bact[-3:-1]:
   ...
   # idx_im, min_value = min(enumerate( abs(sp_sch[sch_name].df['date_time']-im_time)), key=operator.itemgetter(1)) 
    ...
    ax[2].plot(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.sat_scale1[:idx_im],'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='No Bacteria',markevery=2)
    ...
    ax[3].semilogy(sp_sch[sch_name].df.time_days[:idx_im], sp_sch[sch_name].df.suc_scale1[:idx_im],'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='No Bacteria',markevery=2)
