...
ax[0].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.cum_evap_scale1*constants.m2mm,'o',color='brown'  ,markersize=ms,markeredgewidth=mew, markeredgecolor='brown'  ,label='Basin1',markevery=1)
ax[0].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.cum_evap_scale2*constants.m2mm,'s',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',label='Basin2',markevery=2)
sch_name='bacteria_second'
ax[0].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.cum_evap_scale1*constants.m2mm,'o',color='brown',markersize=ms,markeredgewidth=mew, markeredgecolor='brown',markevery=1)
ax[0].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.cum_evap_scale2*constants.m2mm,'s',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',markevery=2)
sch_name='bacteria_third'
ax[0].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.cum_evap_scale1*constants.m2mm,'o',color='brown',markersize=ms,markeredgewidth=mew, markeredgecolor='brown',markevery=1)
ax[0].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.cum_evap_scale2*constants.m2mm,'s',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',markevery=2)

sch_name='bacteria_first'
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.evap_rate_scale1*constants.ms2mmday,'o',color='brown'  ,markersize=ms,markeredgewidth=mew, markeredgecolor='brown'  ,label='Basin1',markevery=1)
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.evap_rate_scale2*constants.ms2mmday,'s',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',label='Basin2',markevery=2)
sch_name='bacteria_second'
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.evap_rate_scale1*constants.ms2mmday,'o',color='brown',markersize=ms,markeredgewidth=mew, markeredgecolor='brown',markevery=1)
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.evap_rate_scale2*constants.ms2mmday,'s',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',markevery=2)
sch_name='bacteria_third'
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.evap_rate_scale1*constants.ms2mmday,'o',color='brown',markersize=ms,markeredgewidth=mew, markeredgecolor='brown',markevery=1)
ax[1].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.evap_rate_scale1*constants.ms2mmday,'s',color='orange',markersize=ms,markeredgewidth=mew, markeredgecolor='orange',markevery=2)


sch_name='bacteria_first'
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo0,'o',color='red',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='red',label='Moisture 1')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo1,'o',color='green',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='green',label='Moisture 2')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo2,'o',color='cyan',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='cyan',label='Moisture 3')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo3,'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Moisture 4')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo4,'o',color='black',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='black',label='Moisture 5')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo5,'o',color='blue',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='blue',label='Moisture 6')
sch_name='bacteria_second'
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo0,'o',color='red',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='red')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo1,'o',color='green',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='green')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo2,'o',color='cyan',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='cyan')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo3,'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo4,'o',color='black',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='black')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo5,'o',color='blue',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='blue')
sch_name='bacteria_third'
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo0,'o',color='red',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='red')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo1,'o',color='green',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='green')
ax[2].plot(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.mmo2,'o',color='cyan',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='cyan')
...
sch_name='bacteria_first'
ax[3].semilogy(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.suc_scale1,'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown',label='Basin1')
ax[3].semilogy(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.suc_scale2,'o',color='orange',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='orange',label='Basin2')
sch_name='bacteria_second'
ax[3].semilogy(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.suc_scale1,'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown')
ax[3].semilogy(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.suc_scale2,'o',color='orange',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='orange')
sch_name='bacteria_third'
ax[3].semilogy(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.suc_scale1,'o',color='brown',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='brown')
ax[3].semilogy(sp_sch[sch_name].df.time_days, sp_sch[sch_name].df.suc_scale2,'o',color='orange',markersize=ms,markeredgewidth=mew,fillstyle='full', markeredgecolor='orange')
